...
// Error ของ /admin — ต้องไม่พังทั้งระบบเมื่อ admin API ล้ม (Phase 12)
  ...
  return (
    <main className="min-h-screen p-4 flex items-center justify-center">
      <div className="max-w-md w-full bg-gray-800 rounded-xl p-6 text-center">
        ...
        <h1 className="text-xl font-bold text-white mb-2">หน้าแอดมินโหลดไม่สำเร็จ</h1>
        <p className="text-sm text-gray-400 mb-5">ตรวจสอบสิทธิ์ (ADMIN/MODERATOR) แล้วลองใหม่</p>
